...
class Cosign < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      ...
      sha256 "991c3f961f901aec75a4068ac2c3046bd5ab36d00cba6ddbf231b5d0123c83ba"
    end

    if Hardware::CPU.arm?
      url "https://github.com/sigstore/cosign/releases/download/v#{version}/cosign-darwin-arm64"
      sha256 "d6ceb52358b69e02ddc2194d47cf5587e8c4885aaa0b9dbb98f0902410adc2aa"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.intel?
      ...
      sha256 "080c0ba10674d2909fb3b4b867b102aefa021959edf2696c8cc1ba08e824bcca"
    end

    if Hardware::CPU.arm?
      url "https://github.com/sigstore/cosign/releases/download/v#{version}/cosign-linux-arm64"
      sha256 "9b7551a871f14b4c278a7857c2cc7d9366b922ed9a4c73387f507ab25cfec46a"
    end
  end
